...
- `0.introduction.md`
- `1. Stage 1: Discover — Opportunities.md`
- `2. Stage 2a: Analyze — LP Due Diligence.md`
- `3. Stage 2b: Analyze — CA Due Diligence.md`
- `4. Stage 3: Propose — Action selection and transaction construction.md`
- `5. Stage 4: Preview — Universal transaction validation.md`
- `6. Stage 5: Execute — Approval and submission.md`
- `7. Stage 6a: Monitor — LP.md`
- `8. Stage 6b: Monitor — CA.md`
- `9. Appendix A: Historical Series Summary.md`
